...
class DQN_FCN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(2, 32, 3, stride=1)  #7X6
...
class DQN_FCN_WIDE(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(2, 64, 3, stride=1)  #7X6
        self.conv2 = nn.Conv2d(64, 256, 3, stride=1)  #5X4
        #self.conv3 = nn.Conv2d(128, 512, 3, stride=1)  #3X2
        self.linear4 = nn.Linear(256*3*2, 2048)  #4X4X16
        self.linear5 = nn.Linear(2048, 512)
        self.linear6 = nn.Linear(512, 7)
